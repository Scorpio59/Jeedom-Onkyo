...
echo 70 > /tmp/onkyo_dep
sudo npm install --unsafe-perm net
echo 75 > /tmp/onkyo_dep
sudo npm install --unsafe-perm async
echo 80 > /tmp/onkyo_dep
sudo npm install --unsafe-perm events
echo 85 > /tmp/onkyo_dep
sudo npm install --unsafe-perm request
echo 90 > /tmp/onkyo_dep
